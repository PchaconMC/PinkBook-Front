  ...
  <div style="padding-top:30px;display:flex;flex-wrap:wrap">
    ...
    <div id="containerForm">
      <div class="row mt-5">
        ...
        <div class="col-12">
          <button class="site-btn boton" @click="createBook">Guardar</button>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    createBook() {
      ...
      if (this.imagen != null) {
        dataBook.append("photo", this.imagen);
      }
      this.booksService
        .createBook(dataBook)
        .then(() => {
          this.$bvToast.toast("Felicidades tu recomendacion se ha guardado", {
            title: "Registro de recomendación",
            autoHideDelay: 5000,
            appendToast: false,
            variant: "danger",
...
#rellenoDerecha{
  width:20%;margin:0px auto;margin-top:10px
}
