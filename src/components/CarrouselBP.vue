  ...
  <div class="card-carousel-wrapper">
    ...
    <div class="card-carousel">
      <div class="card-carousel--overflow-container">
        ...
        >        
          <div class="card-carousel--card" v-for="(item,index) in items" :key="index" @click="$router.push({ name: 'Detail', params: { id: item.id } })">
            <!-- <img :src="'https://loremflickr.com/200/200/book?random='+item.id" /> -->
            <img :src="apiUrl+item.image" :height="200" />
